...
![image-20220114202710730](https://www.coderdu.tech/image/image-20220114202710730.png)
...
![image-20220114202728127](https://www.coderdu.tech/image/image-20220114202728127.png)
...
![image-20220114202738105](https://www.coderdu.tech/image/image-20220114202738105.png)
...
![image-20220114202755005](https://www.coderdu.tech/image/image-20220114202755005.png)
...
![image-20220114202852617](https://www.coderdu.tech/image/image-20220114202852617.png)

Appendable 接口可以将 char 类型的数据读入到`数据缓冲区`
![image-20220114202905901](https://www.coderdu.tech/image/image-20220114202905901.png)

OutputStreamWriter 处理流

OutputStreamWriter 的功能是将`输出字节流`转成`输出字符流`，与 InputStreamReader 相对应的，将`输入字节流`转成`输入字符流`
![image-20220114202923524](https://www.coderdu.tech/image/image-20220114202923524.png)
...
![image-20220114203006564](https://www.coderdu.tech/image/image-20220114203006564.png)

缓冲流又可以分为字节缓冲流和字符缓冲流，按照方向再细分，又可以分为字节输入缓冲流和字节输出缓冲流，以及字符输入缓冲流和字符输出缓冲流。

![image-20220114203035230](https://www.coderdu.tech/image/image-20220114203035230.png)
