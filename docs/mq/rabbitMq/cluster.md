...
2. 配置各个节点的 hosts 文件，让各个节点都能互相识别对方
    ...
    ![image-20220227171608873](https://coderdu.com/image/image-20220227171608873.png)
...
2. 随便找一个节点添加 policy
    ...
    ![image-20220227175237916](https://coderdu.com/image/image-20220227175237916.png)

3. 在 node1 上创建一个队列发送一条消息，队列存在镜像队列

    ![image-20220227175257411](https://coderdu.com/image/image-20220227175257411.png)

4. 停掉 node1 之后发现 node2 成为镜像队列

    ![image-20220227175323583](https://coderdu.com/image/image-20220227175323583.png)
...
![image-20220227175427065](https://coderdu.com/image/image-20220227175427065.png)
...
2. 修改 node1 和 node2 的 haproxy.cfg
    ...
    ![image-20220227175626908](https://coderdu.com/image/image-20220227175626908.png)
...
![image-20220227180626836](https://coderdu.com/image/image-20220227180626836.png)
...
2. 在每台机器上开启 federation 相关插件
    ...
    ![image-20220227180712615](https://coderdu.com/image/image-20220227180712615.png)

3. 原理图(先运行 consumer 在 node2 创建 fed_exchange)

    ![image-20220227180730583](https://coderdu.com/image/image-20220227180730583.png)

4. 在 downstream(node2)配置 upstream(node1)

    ![image-20220227180744648](https://coderdu.com/image/image-20220227180744648.png)

5. 添加 policy

    ![image-20220227180755427](https://coderdu.com/image/image-20220227180755427.png)

6. 配置成功

    ![image-20220227180811578](https://coderdu.com/image/image-20220227180811578.png)
...
1. 原理图
    ...
    ![image-20220227180925145](https://coderdu.com/image/image-20220227180925145.png)

2. 添加 upstream(同上)

3. 添加 policy

    ![image-20220227180943139](https://coderdu.com/image/image-20220227180943139.png)
...
1. 开启插件(需要的机器都开启)
    ...
    ![image-20220227181109640](https://coderdu.com/image/image-20220227181109640.png)

2. 原理图(在源头发送的消息直接回进入到目的地队列)

    ![image-20220227181121369](https://coderdu.com/image/image-20220227181121369.png)

3. 添加 shovel 源和目的地

    ![image-20220227181134009](https://coderdu.com/image/image-20220227181134009.png)
